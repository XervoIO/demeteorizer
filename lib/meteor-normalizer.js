...
util.inherits(Normalizer, EventEmitter);

//--------------------------------------------------------------------------------------------------
Normalizer.prototype.normalize = function(input, output, callback) {
...
//--------------------------------------------------------------------------------------------------
Normalizer.prototype.setupOutputFolder = function(output, callback) {
...
//--------------------------------------------------------------------------------------------------
Normalizer.prototype.bundle = function(bundle, callback) {
...
//--------------------------------------------------------------------------------------------------
Normalizer.prototype.extract = function(bundle, output, callback) {
...
//--------------------------------------------------------------------------------------------------
Normalizer.prototype.createPackageJSON = function(output, callback) {
